    ...
    <div className="relative flex min-h-screen items-center justify-center bg-[#030303] px-4 overflow-hidden">
      <div className="w-full max-w-md animate-fade-in relative z-10">
        ...
        <div className="rounded-2xl p-8 shadow-2xl border border-[#141d30] bg-[#090e1a]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 flex items-center justify-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-500 py-3 text-sm font-semibold text-white transition-all shadow-lg shadow-blue-500/10 hover:shadow-blue-500/20 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer active:scale-[0.98]"
            >
              {loading ? (
                <>
        ...
        <p className="mt-6 text-center text-xs text-gray-500">
          ...
          <a href="/login" className="text-blue-400 hover:text-blue-300 font-semibold transition-colors hover:underline">
            Sign in
          </a>
        </p>
      </div>
